...
import com.food.ordering.system.dataacess.restaurant.exception.RestaurantDataAccessException;
...
public class RestaurantDataAccessMapper {
    ...
    public Restaurant restaurantEntityToRestaurant(List<RestaurantEntity> restaurantEntities) {
        ...
        List<Product> restaurantProducts = restaurantEntities
                .stream().map(entity -> new Product(new ProductId(entity.getProductId()), entity.getProductName(),
