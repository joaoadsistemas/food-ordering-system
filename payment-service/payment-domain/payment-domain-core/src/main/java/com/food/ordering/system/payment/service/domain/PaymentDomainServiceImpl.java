...
import static com.food.ordering.system.domain.constant.DomainConstant.UTC;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    private static Money getTotalHistoryAmount(List<CreditHistory> creditHistories, TransactionalType transactionalType) {
        return creditHistories.stream().filter(
                        creditHistory -> transactionalType == creditHistory.getTransactionalType())
